...
public class RobotAPates extends Robot {
     ...
     */
    public RobotAPates(IGraph _graph, Node _startNode, IShorterPathSearch _pathFinder, Integer _decreaseFireLevelCapacity) {
        super(Capacity.APateCapacity(), _graph, _startNode, _pathFinder, _decreaseFireLevelCapacity);
    }
